...
\subsection{Changes in the Standard}
The Matrix standard is designed to be developed in the open, and has an established process for change\cite{matrix_org_spec_changes}.
