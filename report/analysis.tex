...
\begin{figure}
      \centering
      \resizebox{0.5\linewidth}{!}{\input{graphics/dendrite_design.tex}}
      \caption{
...
The JavaScript implementation is capable of peer discovery across the internet using a protocol known as the WebSocket Star protocol, the source code is at \github{libp2p/js-libp2p-websocket-star}.
...
\begin{figure}
      \centering
      \resizebox{0.4\linewidth}{!}{\input{graphics/p2p-embed.tex}}
      \caption{
